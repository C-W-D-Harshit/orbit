...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <div className="w-full">
      <form
        className={cn(
          "w-full relative mx-auto flex items-center bg-white dark:bg-background border min-h-12 rounded-3xl overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200",
          value && "bg-gray-50"
        )}
      ...
      /> */}
        ...
        <button
          ...
          type="submit"
          ref={btnRef}
          className="absolute right-2 z-50 h-8 w-8 rounded-full disabled:bg-gray-100 bg-black dark:bg-zinc-900 dark:disabled:bg-zinc-800 transition duration-200 flex items-center justify-center"
        >
          <motion.svg
